    ...
    <>
      ...
      <div style={{ maxWidth: "500px" }}>
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <p style={{ fontSize: "0.8rem", color: "var(--color-muted)", marginBottom: "0.5rem" }}>{cfg.siteName}</p>
          <input type="text" defaultValue={cfg.siteName} style={{ width: "100%", padding: "0.5rem 0.75rem", border: "1px solid var(--color-border)", borderRadius: "var(--radius)", fontSize: "0.875rem" }} readOnly />
        </div>
        <div style={{ marginBottom: "1.5rem" }}>
